    ...
    createClass(Canvas, [{
        ...
        value: function componentDidMount() {
            ...
            this._oid = setTimeout(function () {
                ...
                try {
                    ExecutionEnvironment.canUseDOM && window.addEventListener("resize", _this2.resize);
                } catch (e) {
        ...
        value: function componentWillUnmount() {
            try {
                ExecutionEnvironment.canUseDOM && window.removeEventListener("resize", this.resize);
