...
参考如下核心文档：[`synscan.Scan`](/docs/api/synscan#scan)
...
的无缝对接，这个接口就是 [`servicescan.ScanFromSynResult`](/docs/api/servicescan#scanfromsynresult)
...
我们使用 [`servicescan.ScanFromSynResult`](/docs/api/servicescan#scanfromsynresult) 只修改了非常少量的代码，就可以把 `synscan`
