...
我们 yak 语言中，内置了很多功能库，这些功能库并不需要用户手动来导入，直接 `package_name.methodName` 即可调用，例如我们本节教程将会遇见的案例：[`cli.String`](/docs/api/cli#string) 这些案例
...
1. 大家可以打开 [servicescan 的 API手册](/docs/api/servicescan#scan) 自行查看相关接口 
1. 也可以查看这个模块的详细文档：[](/)
