...
1. [yak.fuzz 基础教程](/api-manual/yakexamples/fuzz_tutorial)
1. [yak.fuzz 高级教程](/api-manual/yakexamples/fuzz_for_more)
...
我们只需要把 [插件编写指南：插件交互式输出](/products/legacy/Plugin-repository/plugins/plugin_output) 中介绍的交互方法加以应用即可生成一个美观好用的插件了！
...
[漏洞 PoC 规模化验证](/api-manual/yakexamples/how_to_make_poc#%E6%BC%8F%E6%B4%9E-poc-%E8%A7%84%E6%A8%A1%E5%8C%96%E6%AD%A6%E5%99%A8%E5%8C%96)
