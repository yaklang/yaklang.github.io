...
![](/img/products/yakit/yakit-update-poc.jpg)

点击之后，我们将会看到 PoC 更新的整个流程，更新成功后，结果如下

![](/img/products/yakit/yakit-update-poc-result.jpg)
...
![](/img/products/yakit/yakit-poc-loaded.jpg)
