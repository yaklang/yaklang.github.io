---
title: "Java 安全：Java 脏数据填充技术探索"
date: 2024-03-22
authors: [yak]
tags: ["2024", "java-sec"]
slug: java-dirty-data-padding-techniques
---
**前言**

<!-- truncate -->

有用户提出了 Yso JavaHack 的生成序列化 payload 需要填充脏数据的需求，由于yak引擎没有java环境，所以不能直接对gadget封装，只能对数据化流操作，记录下分析过程。
...
![image](/blog-img/dbc18c409d992c1f.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/fItvm9lwXlWnGo8_-JB-hA)。
