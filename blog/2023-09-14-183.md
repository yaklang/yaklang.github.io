---
title: "渗透实战：验签与前端加密分析（一）"
date: 2023-09-14
authors: [yak]
tags: ["2023", "crypto"]
slug: signature-verification-and-frontend-encryption-part1
---
**“开局一个登录框”**
...
![image](/blog-img/5b165fddbaa4a9e3.png)

当我们把这个表单提交给后端之后，将会看到后端的验证结果：分别是 “签名验证成功”，“用户名密码验证失败”

![image](/blog-img/0d152c7e7f7809fa.png)
...
![image](/blog-img/36ab2697cc4f4393.png)

在这种情况下，我们想要重放数据包，从 `password`这个字段入手，爆破一下密码，自然也是不行的：那么难道真的就一筹莫展了嘛？

![image](/blog-img/02b032ab715ca056.png)
...
![image](/blog-img/cc143d09b3251386.png)
...
![image](/blog-img/5daeb00e5d19dcc7.png)
...
![image](/blog-img/d00baed0afb973de.png)
...
![image](/blog-img/78e7417b18fd12c4.png)
...
![image](/blog-img/6768ea795043d140.png)
...
![image](/blog-img/b798c741dd9f92f7.png)

**成功爆破**

在我们基础验证之后，根据前面的一些经验，我们可以使用高级配置中的“变量”来加载我们的字典，达到爆破的目的：

![image](/blog-img/48415c9c34267c8c.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/ni3sVp0Gh-CwyMPuwk__Cw)。
