---
title: "渗透实战：对抗前端动态密钥与非对称加密（二）"
date: 2023-10-11
authors: [yak]
tags: ["2023", "crypto"]
slug: bypassing-frontend-dynamic-keys-part2
---
**前言**
...
![image](/blog-img/8dc656d61cd04e56.png)
...
![image](/blog-img/1d6a8bce1ef11147.png)

首先打开网站，抓包看一下通信流程发现网站请求完资源后会去加载一套证书：

![image](/blog-img/eec13620b0f7ac97.png)

因此我们需要去寻找 JavaScript 中的加密线索：

![image](/blog-img/f4c24a2f5f0c1edb.png)
...
![image](/blog-img/6850eabbdd34776a.png)

**01**

## **捋清思路，准备动手**

![image](/blog-img/2fc0654a82d0a9ac.png)
...
![image](/blog-img/bd12e1448504d768.png)
...
![image](/blog-img/18167632edf3cd9d.png)
...
![image](/blog-img/2c9bf198e89ef4d3.png)
...
![image](/blog-img/4037f0193dec62f7.png)

可以，非常棒，接下来我们就可以直接修改用户名和密码来进行爆破了对吧？利用这种特性，我们在第二个请求中，需要对用户名和密码进行爆破：

![image](/blog-img/664eb5bc8f747754.png)
...
![image](/blog-img/89cabc079bf8122d.png)
...
![image](/blog-img/d4576486fd2f1917.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/gMbbEV62XR5_QCACQwZnOw)。
