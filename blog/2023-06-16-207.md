---
title: "Java 安全：Fastjson 结合 JDK 原生反序列化利用（Aliyun CTF）"
date: 2023-06-16
authors: [yak]
tags: ["2023", "java-sec", "range"]
slug: fastjson-with-jdk-deserialization-aliyun-ctf
---
...
的文章，文中提到低版本才能利用，但其实高版本也能利用，这是因为后来有人提出可以利用 **java 序列化机制中的引用机制来进行绕过**
