---
title: "功能发布：Yakit 新版 Codec 序列式编解码"
date: 2024-03-14
authors: [yak]
tags: ["2024"]
slug: yakit-codec-sequential-encoding
---
**前言**
...
![image](/blog-img/46e3609a7bb62cfe.png)

除此之外，每一条Codec方法的右侧都有收藏按钮，点击即可将其加入收藏，在顶部可以直接找到

![image](/blog-img/42f5dc75c1b954e0.png)
...
![image](/blog-img/21806605bab46163.png)
...
![image](/blog-img/ee2673667dfd7fbf.png)
...
![image](/blog-img/ab2a9f6be56f1103.png)

- 本地Codec插件：此处可以搜本地已有的Codec插件直接使用。当然也可以到Yakit插件商店里下载社区用户分享的 Codec 插件使用。

![image](/blog-img/ee78730e5e1d3053.png)
...
现有的插件商店里，有团队成员写的 **OpenAI - 检测编码** 插件案例。

先对 `Hello Yakit Codec` 进行base64+URL编码，再使用编码检测来识别它。

![image](/blog-img/58ede004da6ee46b.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/zCFc2KXZPon-RKlfepBNpg)。
