---
title: "工程实践：使用 Fuzztag 生成与变形 Payload"
date: 2022-10-20
authors: [yak]
tags: ["2022", "webfuzzer"]
slug: generate-payloads-with-fuzztag
---
背景
...
在过去的一年中，Fuzztag 作为 Yakit 一开始就携带的特性，已经陪很多用户完成了很多工作内容。与此同时，Fuzztag 自身也在不断进化，从一开始只支持少量标签的场景，到后来支持复杂的热加载 Yak 代码编辑系统，再到支持 Web Fuzzer 的自动补全以及无限嵌套。
