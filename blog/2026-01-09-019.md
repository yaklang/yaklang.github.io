---
title: "功能发布：IRify 代码审计报告生成功能"
date: 2026-01-09
authors: [yak]
tags: ["2026", "code-audit"]
slug: irify-code-audit-report-generation
---
...
![image](/blog-img/4567d25d6817dee2.png)

选择你需要生成报告的扫描任务，然后生成报告：

![image](/blog-img/b1851e274ea0d030.png)

报告生成后，即可在客户端内预览：

![image](/blog-img/9f22394b4861755b.png)
...
![image](/blog-img/abbd6aa11b6dfe85.png)

进入 AI Agent 界面：

![image](/blog-img/f3d0998bf3eff93f.png)

选择如图模板：

![image](/blog-img/3e96f46714d5fa63.png)

填入 RiskID 和保存路径运行：

![image](/blog-img/9fc6c8dbcbda94d7.png)

生成结束后可以找到生成的报告：

![image](/blog-img/3d40a4ae8723e68b.png)

同时，在右侧自由对话中可以在报告生成完毕后继续和 AI 对话。此时 AI 上下文中包含了这个 Risk 所关联文件和项目的信息。

![image](/blog-img/440a2956a5c5260a.png)
...
![image](/blog-img/e832d36a5b0e4385.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/H0vW2aju9F4rPHXZVBh67Q)。
