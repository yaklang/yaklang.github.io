---
title: "Java 安全：反序列化回显链研究与检测工程化"
date: 2022-04-01
authors: [yak]
tags: ["2022", "java-sec"]
slug: java-deserialization-echo-chain-detection
---
回显方案选择
...
![image](/blog-img/6339524fcde51c8d.png)

因为web端口可以和外界通讯（收到请求包，返回响应包），所以最优方案就是通过请求包发送命令，响应包回传执行结果

通过JAVA代码执行回显

![image](/blog-img/fbc9acfe9a391550.jpg)
...
![image](/blog-img/0ba0e36e81b2c3f1.png)
...
![image](/blog-img/c306024185bebb7f.png)

这里是文件名，字符串前的0017是“`TomcatEchoTemplate.java`”的长度

![image](/blog-img/2383dda6807b441f.png)

这里的0012是`TomcatEchoTemplate`的长度

![image](/blog-img/ad2e601f4173766f.png)
...
![image](/blog-img/9dd176e6ec92f305.png)
...
![image](/blog-img/5f5aeb198e77d421.png)

![image](/blog-img/d237ac869997e2f9.png)
...
![image](/blog-img/23a5c4d8020e7a29.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/zGnx9gSmJmughY62h8T8zQ)。
