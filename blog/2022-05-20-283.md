---
title: "工程实践：Web Fuzzer 对标 Repeater 与 Intruder"
date: 2022-05-20
authors: [yak]
tags: ["2022", "webfuzzer"]
slug: p283
...
![image](/blog-img/4c217de319494bca.png)
...
![image](/blog-img/5ba80a9e5a185338.png)
...
![image](/blog-img/77a79d8c2a33f9d3.png)
...
![image](/blog-img/9fa19a419a020351.png)
...
5. Yak 语言中的 poc.HTTP (https://www.yaklang.io/api-manual/yakexamples/http-raw) 其实和 Web Fuzzer 的核心功能一样，可以说是单体发包的可编程实现。高并发版本是：httpool.Pool (https://www.yaklang.io/api-manual/yakexamples/batch-http)
...
在 Web Fuzzer 静默灰度测试过程中，很多用户提供了非常宝贵的建议，甚至在这篇文章中，很多功能和想法的提出者都是大家非常熟悉的同学，感谢各位用户的鼎力帮助，顺序不分先后
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/sG9NLshZ8Q0l2yhvDcvSJA)。
