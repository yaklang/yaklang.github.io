---
title: "渗透实战：HTB BountyHunter 靶机攻防与武器化"
date: 2022-04-29
authors: [yak]
tags: ["2022", "range"]
slug: htb-bountyhunter-walkthrough-and-weaponization
---
> 一份来自官方的 Yakit 实战案例
...
![image](/blog-img/f3fa5e4227b2b350.png)

起手：确定攻击路径

大致观察之后，我们最直接的丢在 Yakit 中扫描端口开启插件跑跑看：

![image](/blog-img/5dbbacc5ed156f7b.png)

![image](/blog-img/a57e8412997ab7ac.png)
...
![image](/blog-img/7119ade5e2a40bde.png)

XXE 漏洞检查

我们看到参数是 XML 的时候，马上反应过来这应该是一个 XXE 漏洞，那么其实非常简单的，我们应该写一个可以用来测试的脚本：

![image](/blog-img/757bdfe3b98e6a62.png)
...
![image](/blog-img/aac5bbe50cf7a03d.png)
...
![image](/blog-img/345d7f9c0501d84f.png)

XXE + PHP Hack

![image](/blog-img/a10141765d62a1f9.png)
...
![image](/blog-img/c7bd1e03599b42ed.png)

所以我们可以通过 `{{list(db|database|config)}}`... 这种标签生成一个路径文件的组合，然后批量发包测试，测试结果如下

![image](/blog-img/d3e001f8d7bedbed.png)
...
![image](/blog-img/391a7acd5df3ef0c.png)

## **从源码发现一点线索**

![image](/blog-img/6fd668b09033ae34.png)
...
![image](/blog-img/70b5920e014ba2a9.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/-jANeiDufVV0CMu-8-YmeQ)。
