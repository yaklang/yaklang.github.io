---
title: "功能发布：Web Fuzzer 热加载 Fuzz 能力"
date: 2022-05-20
authors: [yak]
tags: ["2022", "webfuzzer", "hotpatch"]
slug: web-fuzzer-hot-reload-fuzz-capability
---
Background
...
![image](/blog-img/0beaf4bdd781a639.png)

按图中配置好后，我们可以通过 “执行” 来调试上述标签渲染是否成功。

![image](/blog-img/a43f2dce27d608d9.png)
...
![image](/blog-img/9799b21c524d95ca.png)
...
![image](/blog-img/ac833086016c5aba.png)

于是我们就可以开心地免去编写完整的 Yak 脚本对其测试了。

![image](/blog-img/929a79dbc2954fda.png)
...
![image](/blog-img/20f9d5d0cadefd48.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/_bsedijrwinhSkeVslaWbQ)。
