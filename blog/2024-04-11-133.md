---
title: "流量分析：使用 Yakit 进行小程序与 App 抓包"
date: 2024-04-11
authors: [yak]
tags: ["2024", "traffic"]
slug: capturing-miniprogram-and-app-traffic
---
**Proxifier 介绍**
...
![image](/blog-img/358873369ca9cfd0.png)

点击劫持启动。

**2、Proxifier 添加 proxy server:**

![image](/blog-img/eb7ed691397b3ba7.png)
...
![image](/blog-img/0ea23eb95a44eafd.png)

Proxifier 会自动添加完毕。

![image](/blog-img/e8e3825ef2ebb48a.png)
...
![image](/blog-img/67b1d1c9fa6abd20.png)
...
![image](/blog-img/621a44c12e0ab2a2.png)
...
![image](/blog-img/709dbba626a1a797.png)

点击后可能会出现如下提示，让你保存当前的规则配置，如果你有其他的一些规则配置，可以点击取消后保存你之前的规则配置

![image](/blog-img/dcc49d2debd6d348.png)

这里我们没有需要保存的规则配置，直接点击是，选择下载的 Yakit-WeChatAppEx.ppx 文件

![image](/blog-img/56656c16d2f37a0e.png)

发现如下的加载成功即可

![image](/blog-img/911ca8c7bfc80ccf.png)

随后即可对小程序进行抓包

![image](/blog-img/36f0fb59b600fa95.png)
...
![image](/blog-img/62408f2a199de74b.png)

一直显示加载中的情况

![image](/blog-img/935579e94243648e.png)
...
![image](/blog-img/b99f695153477580.png)
...
![image](/blog-img/4b570f0d770ae8ff.png)

2.然后将证书复制到模拟器中（直接拖动到模拟器中即可），证书会出现在/storage/emulated/0/Pictures目录中

![image](/blog-img/ab523721cd6fd5b5.png)
...
![image](/blog-img/8e2bad96feaad24e.png)

将证书粘贴到  /etc/security/cacerts 目录下

![image](/blog-img/2b8c44a96d17b62a.png)

点开属性，并赋予权限

![image](/blog-img/39d6168853b87595.png)

5.访问app或网站即可抓到HTTPS的数据包

![image](/blog-img/70d79389671dba89.png)
...
![image](/blog-img/34438a30dcbf0fd6.png)

2.重命名“yakit证书.crt.pem”文件为38555061.0 （图中计算出的hash值）

![image](/blog-img/5e5b357db5cac41c.png)
...
![image](/blog-img/983dcd6ff318a52c.png)
...
![image](/blog-img/a7a603b5206025e3.png)

（7）在模拟器中设置-安全-信任的凭据中确认证书是否添加

![image](/blog-img/e26a5e45f6828d0b.png)

**最后**

本文较长，为了更好地让大家理解并学习，我们已在b站同步上传了视频，读者可以观看配套教程，使用 Yakit 上手实战。**点击文末阅读原文，观看视频。**


---

> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/ey-YftiIHHweP4pGfa58oQ)。
