...
![image](/blog-img/879838b019043e7f.png)

**X.224：会话协议**

它也被称为ISO 8073协议，是一个会话层协议，可以用于链接的建立，管理、数据交换、心跳检测等等，下面是一个X.224报文的结构，其中第一个结构LI指Length Indicator，就是报文长度，占一个字节

![image](/blog-img/6a567b8da4bb3bc6.png)

**RDP交互分析**

如下是一次完整的RDP协议的交互过程

![image](/blog-img/620056049819cda0.png)
...
![image](/blog-img/ed6682f433f6a919.png)
...
![image](/blog-img/994d56db22269664.png)

**RDP_NEG_REQ**

如下是协商请求的结构，其中requestedProtocols字段表明了客户端支持的协议

![image](/blog-img/29cf60c32bb57241.png)

**RDP_NEG_RSP**

在响应报文中选择了一种认证方式，接下来可以使用服务端支持的方式来认证。如下是所有的认证方式。

![image](/blog-img/7c5316a36349e769.png)
...
![image](/blog-img/666e348de6b32d0d.png)
...
![image](/blog-img/10abf2d617991ff4.png)

**NTLMv2算法定义**

如下是官方对NTLMv2 hash计算的定义

![image](/blog-img/1b28f71b2c579052.png)
...
![image](/blog-img/514e53dd452dc03f.png)
...
![image](/blog-img/e4bd8c7c515363ca.png)
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/Flr6Ws3kiy_ZZqyGHDWb8g)。
