---
title: "漏洞分析：Fastjson 启发式检测"
date: 2022-05-27
authors: [yak]
tags: ["2022", "java-sec"]
slug: fastjson-heuristic-detection
---
...
![image](/blog-img/68e290371317e003.png)

这里的ref是value，即com.sun.rowset.JdbcRowSetImpl，然后通过类名加载对应类

![image](/blog-img/445aec5b7d17444d.png)
...
![image](/blog-img/c26d6b502510f64c.png)
...
![image](/blog-img/d4a0b2953759a383.png)
...
![image](/blog-img/2fa442dff1144724.png)

![image](/blog-img/2da5f43e2de157aa.png)
...
![image](/blog-img/4a93e2ff79efa08b.png)
...
![image](/blog-img/bad963834859e36a.png)
...
![image](/blog-img/86c146dc57c7d9ad.png)

在checkAutoType方法中，未开启AutoType情况下会有下面两种加载方式，先看getClassFromMapping

![image](/blog-img/42eb8386d648a831.png)

如图，从mappings中取

![image](/blog-img/252d825faf7547ec.png)

第二种是从deserializers中取，如图deserializers是内置的一些类和对应的反序列化器

![image](/blog-img/8835b3b09b5d6adb.png)
...
![image](/blog-img/4d8a3b31c89daaf4.png)

最后一处在MiscCodec.deserialze方法中

![image](/blog-img/f7d07681d5bedef5.png)

MiscCodec继承了ObjectDeserializer，所以它应该反序列化器，所以去deserializers中看下这是谁的反序列化器

![image](/blog-img/71fdaf9a7b02c7e8.png)
...
![image](/blog-img/fed57c47ec171b48.png)
...
![image](/blog-img/32bc97be3aa91024.png)

![image](/blog-img/8f92922220c2fc5d.png)
...
![image](/blog-img/5f020a556274b80f.png)
...
**注**：测试时发现有时在解析 json 前会判断类型是否匹配，匹配失败则在解析前抛出异常。所以需要将 payload 改造一下，如
...
> 本文首发于 Yak Project 公众号，[阅读原文](https://mp.weixin.qq.com/s/0xQWHeTvimzMB7C6nQHEIw)。
