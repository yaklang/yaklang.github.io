...
| [ffmpeg.withSlicePresetForOmni](#withslicepresetforomni) |WithSlicePresetForOmni 一键预设：根据目标 omni 模型设定段长。 turbo =&amp;gt; 30 秒（模型上限 40s），flash =&amp;gt; 120 秒（上限 150s），plus =&amp;gt; 120 秒 （文档上限 1h，但 base64 实测 300s 会触发 &amp;#3...|
